...
time_series = data["rois_dosenbach160"]
...
for ts in time_series:
    FC = comet.connectivity.Static_Partial(ts).estimate()
...
model = Pipeline([('scaler', StandardScaler()), ('reg', LogisticRegression(penalty='l2', C=1.0, tol=1e-3))])
